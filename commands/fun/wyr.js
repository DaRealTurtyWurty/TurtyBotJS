questions = [ "Would you rather be in jail for a year {a} or lose a year off your life {b}?",
...
"Would you Rather Eat Tacos {a} or Pizza {b}?",
"Would you Rather Get Up Early {a} or Stay Up Late {b}?",
...
module.exports = {
    ...
    run: async(client, message, args) => {
        let question = choose(questions).replace("{a}", '🅰').replace("{b}", '🅱');
